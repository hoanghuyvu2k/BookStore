    ...
    <body>
        <div id="wrap">
            ...
            <div class="center_content">
                ...
                <a class="btn btn-success" href="electronics-admin.jsp">Add</a>
                <table class="table">
                    <thead>
                        <tr>
                            <th scope="col"></th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><%=i+1%></td>
                            <td><%=listElectronics.get(i).getName()%></td>
                            <td><%=listElectronics.get(i).getPrice()%>đ</td>
                            <td><%=listElectronics.get(i).getDiscount()%>%</td>
                            <td>
                                <form action="${pageContext.request.contextPath}/Electronics" method="post">
                                    <input hidden type="text" name="electronicsId" value="<%=listElectronics.get(i).getId()%>" />
